...
class BreakThroughScreen extends StatefulWidget {
  const BreakThroughScreen({Key? key}) : super(key: key);

  @override
  _BreakThroughScreenState createState() => _BreakThroughScreenState();
}

class _BreakThroughScreenState extends State<BreakThroughScreen>
      ...
      body: Padding(
        ...
        child:Column(
          ...
          children: [
            ...
            Text(
              'Get inspired by others who took the first step',
              textAlign: TextAlign.center,
              style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  ...
                  RichText(text: TextSpan(
                    text:
                      'This app has helped me have a closer relationship with God and understand the word. I have been much more committed to my prayer and worship',
                      style: TextStyle(
                        color: const Color(0xFF292929),
                        fontSize: 20,
                        fontFamily: 'Quincy CF',
              ...
              onTap: () {
                ...
                Navigator.push(
                  ...
                  PageRouteBuilder(
                    ...
                    pageBuilder: (_, animation, secondaryAnimation) => WayToConnectWithGod(),
