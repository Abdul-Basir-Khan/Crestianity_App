...
import 'package:my_cristianity_app/onboarding_screen/registeration_screen/agree_to_the_statetment.dart';
...
class WhereDidYouHear extends StatefulWidget {
  const WhereDidYouHear({Key? key}) : super(key: key);

  @override
  _WhereDidYouHearState createState() => _WhereDidYouHearState();
}

class _WhereDidYouHearState extends State<WhereDidYouHear>
  ...
  final List<SocialModel> socialList = [
    SocialModel(
      ...
      imagePath: 'assets/home_icons/community.svg',
    ),
    SocialModel(
      title: "Church",
      imagePath: 'assets/home_icons/church.svg',
    ),
    SocialModel(
      title: 'Twitter (X)',
      imagePath: 'assets/home_icons/twitter.svg',
    ),
    SocialModel(
      title: 'Tiktok',
      imagePath: 'assets/home_icons/tiktok.svg',
    ),
    SocialModel(
      title: 'Instagram',
      imagePath:   'assets/home_icons/instagram.svg',
    ),
    SocialModel(
        title: 'Youtube',
        imagePath:    'assets/home_icons/youtube.svg',),
    SocialModel(
        title: 'Google/Apple app store',
        imagePath:
  ...
  void initState() {
    ...
    _slideAnimations = List.generate(socialList.length, (index) {
