      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
              fit: BoxFit.cover,
              image: AssetImage("assets/home_navigation/Daily Verse.png"))
        ),
        child: Column(
                 ...
                 children: [
                  GestureDetector(
                    ...
                    child: Container(
                        ...
                        decoration: ShapeDecoration(
                          color: isSpeakOrRead==0?Color(0xFF664F42):Colors.transparent,
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(120),
                          ),
                        ),
                        child: Row(
                          ...
                          children: [
                            SvgPicture.asset(
                               color:  isSpeakOrRead==0?Colors.white:Color(0xff664F42),
                   ...
                   GestureDetector(
                     ...
                     child: Container(
                         padding: const EdgeInsets.symmetric(horizontal: 10,vertical: 6),
                         decoration: ShapeDecoration(
                           color: isSpeakOrRead==1?Color(0xFF664F42):Colors.transparent,
                           shape: RoundedRectangleBorder(
                             borderRadius: BorderRadius.circular(120),
                           ),
                         ),
                         child: Row(
                           ...
                           children: [
                             SvgPicture.asset(
                                 color:  isSpeakOrRead==1?Colors.white:Color(0xff664F42),
